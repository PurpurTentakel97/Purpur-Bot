...
def insert_command(bot_id: int, command_name: str, command_message: str) -> Result[int]:
...
def update_command(bot_id: int, command_name: str, data: dict[str, Any]) -> Result[None]:
